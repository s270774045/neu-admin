...
<div class="container-fluid">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">业务能力修改</h1>
	    </div><!-- /.col-lg-12 -->
	</div><!-- /.row -->
	<div class="row">
	    <div class="col-lg-12">
	        <div class="panel panel-default">
	            ...
	            <div class="panel-body">
                    <form id="form" role="form" class="form-horizontal">
                        <input type="hidden" id="employeeId" name="employeeId" value="${param.id}">
				       	...
				       	<div class="row">
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="hidden" class="form-control" id="catalog" name="catalog" value="${entity.catalog}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-6">
				        ...
				        <div class="row">
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input class="form-control" id="startDate" name="startDate" value="${entity.startDate}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input class="form-control" id="endDate" name="endDate" value="${entity.endDate}">
				                    </div>
				                </div>
				            </div>
				        </div>
				        <div class="row">
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="hidden" class="form-control" id="mode" name="mode" value="${entity.mode}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input class="form-control" id="goal" name="goal" value="${entity.goal}">
				                    </div>
				                </div>
				            </div>
				        </div>
				        <div class="row">
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input class="form-control" id="content" name="content" value="${entity.content}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input class="form-control" id="score" name="score" value="${entity.score}">
				                    </div>
				                </div>
				            </div>
				        </div>
				        <div class="row">
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="hidden" class="form-control" id="issue" name="issue" value="${entity.issue}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-6">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input class="form-control" id="certificate" name="certificate" value="${entity.certificate}">
				                    </div>
				                </div>
				            </div>
				        </div>
