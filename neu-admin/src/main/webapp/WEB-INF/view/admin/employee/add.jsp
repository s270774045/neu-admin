...
<div class="container-fluid">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">员工信息新增</h1>
	    </div><!-- /.col-lg-12 -->
	</div><!-- /.row -->
	<div class="row">
	    <div class="col-lg-12">
	                    ...
	                    <div class="row">
		                    <div class="col-sm-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-8">
		                                <input class="form-control" id="employeeName" name="employeeName" required="true">
		                            </div>
		                        </div>
		                    </div>
		                    <div class="col-sm-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-8">
		                                <input class="form-control" id="sapCode" name="sapCode">
		                            </div>
		                        </div>
		                    </div>
		                </div>
		                <div class="row">
		                    ...
		                    <div class="col-sm-6">
		                        <div class="form-group">
		                            ...
		                            <div class="col-sm-8">
		                                <input type="hidden" class="form-control" id="sexual" name="sexual" value="<%=AdminConstant.Sexual.MALE.getId() %>">
		                            </div>
		                        </div>
		                    </div>
		                </div>
