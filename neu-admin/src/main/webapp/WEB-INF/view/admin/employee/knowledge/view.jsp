...
<div class="container-fluid">
	<div class="row">
	    <div class="col-lg-12">
	        <h1 class="page-header">专业知识修改</h1>
	    </div><!-- /.col-lg-12 -->
	</div><!-- /.row -->
	<div class="row">
	    <div class="col-lg-12">
				       	...
				       	<div class="row">
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
										<input class="form-control" id="date" name="date" value="${entity.date}" required="true">
				                    </div>
				                </div>
				            </div>
				        </div>
				       	<div class="row">
				            ...
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="safe1" value="${entity.safe1}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="theory1" value="${entity.theory1}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="practice1" value="${entity.practice1}">
				                    </div>
				                </div>
				            </div>
				        </div>
				       	<div class="row">
				            ...
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="safe2" value="${entity.safe2}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="theory2" value="${entity.theory2}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="practice2" value="${entity.practice2}">
				                    </div>
				                </div>
				            </div>
				        </div>
				       	<div class="row">
				            ...
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="theory3" value="${entity.theory3}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="safe3" value="${entity.safe3}">
				                    </div>
				                </div>
				            </div>
				        </div>
				       	<div class="row">
				            ...
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="score" value="${entity.score}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				       	...
				       	<div class="row">
				            ...
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="winter" value="${entity.winter}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="risk" value="${entity.risk}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="standard" value="${entity.standard}">
				                    </div>
				                </div>
				            </div>
				            <div class="col-sm-4">
				                <div class="form-group">
				                    ...
				                    <div class="col-sm-6">
				                        <input type="number" class="form-control" name="flood" value="${entity.flood}">
				                    </div>
				                </div>
				            </div>
				        </div>
