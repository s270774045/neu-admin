...
<body>
    ...
    <div id="wrapper">
					...
					<ul class="nav navbar-top-links navbar-right">
						...
						<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
							...
							<ul class="dropdown-menu dropdown-user">
								<li><a href="${ctx}/admin/changePass"><i class="fa fa-user fa-fw"></i> 修改密码</a></li>
								<li><a href="#"><i class="fa fa-gear fa-fw"></i> 设置</a></li>
								<li class="divider"></li>
								<li><a href="${ctx}/admin/logout"><i class="fa fa-sign-out fa-fw"></i> 退出登录</a></li>
							</ul> <!-- /.dropdown-user --></li>
						<!-- /.dropdown -->
					</ul>
					<!-- /.navbar-top-links -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> 员工信息管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="${ctx}/admin/employee/list"><i class="fa fa-users fa-fw"></i> 基本信息</a>
                                    <a href="${ctx}/admin/employee/knowledge/employeeList"><i class="fa fa-users fa-fw"></i> 专业知识</a>
                                    <a href="${ctx}/admin/employee/ability/employeeList"><i class="fa fa-users fa-fw"></i> 业务能力</a>
                                </li>
                            </ul>
                        </li>
                        <!--
                        <li>
                            <a href="${ctx}/admin/employee/list"><i class="fa fa-th-list fa-fw"></i> 员工信息管理</a>
                        </li>
                        -->
                    </ul>
                </div>
        ...
        <!-- Page Content -->
        <div id="page-wrapper">
	        <iframe src="${ctx}/admin/employee/list"></iframe>
        </div>
        <!-- /#page-wrapper -->
