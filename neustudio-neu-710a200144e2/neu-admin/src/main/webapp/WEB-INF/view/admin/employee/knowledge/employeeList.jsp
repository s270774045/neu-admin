	...
	table = $('#table').DataTable({
        ...
        columnDefs: [{
	        ...
	        render: function (a, b, c, d) {
	            var html = " ";
	            html += '<button type="button" class="btn btn-primary btn-xs" onclick="view(\'' + c.id + '\')">专业知识</button> ';
	            return html;
	        }
	    }]
	});
...
function view(id){
	window.location.href="${ctx}/admin/employee/knowledge/list?employeeId="+id;
}
