	        ...
	        <div class="panel panel-default">
	            <div class="panel-heading">
			        <div class="btn-group btn-group-sm pull-right" role="group" aria-label="...">
			          <button type="button" class="btn btn-default" id="btnAdd">新增员工信息</button>
...
$(function() {
	...
	$("#btnAdd").on("click", function(){
		window.location.href="${ctx}/admin/employee/add";
	});
...
function view(id){
	window.location.href="${ctx}/admin/employee/view?id="+id;
}

function del(obj){
	$.ajax({
		url:"${ctx}/admin/employee/del",
		method:"post",
		data:$(obj).data(),
		dataType:"json",
		success:function(r){
